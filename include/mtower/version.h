/**
 * @file        include/mtower/version.h
 * @brief       mTower version declarations
 *
...
#ifndef __INCLUDE_MTOWER_VERSION_H_
#define __INCLUDE_MTOWER_VERSION_H_
...
#endif /* __INCLUDE_MTOWER_VERSION_H_ */
