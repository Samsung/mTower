...
// static int32_t xTaskListTasksShowStack[ 128 ] __attribute__( ( aligned( 32 ) ) ); 
...
//     LOG_I("Create semaphore is success\r\n");

//     xTaskListTasksShowStack[0] = 0xAABBCCDD;
...
//         // },
//         [0] = {
//             .entry_flag = ENTRY_FLAG_ADDR_NAPOT | ENTRY_FLAG_PERM_R,
//             .entry_pa_base = xTaskListTasksShowStack,
//             .entry_pa_length = 512,
//         }
//     };
...
//     xTaskListTasksShowStack[0] = 0x11223344;
    
//     LOG_I("Write is success\r\n");
...
static void menuTask(void *pvParameters) PRIVILEGED_FUNCTION
{
  ...
  do
  {
	...
	printf("| [1] - Run 2 unprvl apps & demo interaction between themem  |\r\n");
...
int main( void )
{
	...
	printf("\n\n\t-=mTower v0.5.0"  "=-  " __DATE__ "  " __TIME__"\r\n\n");
